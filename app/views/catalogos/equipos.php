...
?>    
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3">
				<a href="<?php echo base_url(); ?>nuevo_equipo" type="button" class="btn btn-success btn-block">Nueva equipo</a>
			</div>
		</div>
		<br>
		...
		<div class="panel panel-primary">
			...
			<div class="col-md-12">				
				<div class="table-responsive">
					...
					<section>
						<table id="tabla_cat_equipos" class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th class="text-center cursora" style="width:90%">equipo</th>
